      ...
      <td>
        <div class="compact-cell">
          ...
          <div class="compact-file-row">
            <label class="file-btn"><input type="file" data-upload hidden />Файл</label>
...
function bindEvents() {
  ...
  el('dealsTbody').addEventListener('input', (e) => {
    ...
    updateDeal(tr.dataset.id, e.target.dataset.field, e.target.value);
  });
